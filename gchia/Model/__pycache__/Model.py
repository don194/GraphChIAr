...
class ChIAPETMatrixPredictor_efeaturesq(nn.Module):
    def __init__(
        self,
        resolution,
        window_size,
...
class ChIAPETMatrixPredictor_efeaturesq_high(nn.Module):
    def __init__(
        self,
        resolution,
        window_size,
...
class ChIAPETMatrixPredictor_efeaturesq_noPE(nn.Module):
    def __init__(
        self,
        resolution,
        window_size,
    ...
    def forward(self, data):
        ...
        return matrix_pred
# class ChIAPETMatrixPredictor_efeature_nosq(nn.Module):
#     def __init__(
#         self,
#         resolution,
#         window_size,
...
class ChIAPETMatrixPredictor_efeature_noseq(nn.Module):
    def __init__(
        self,
        resolution,
        window_size,
